...
Route::get('/mail-test-v3', function() {
    try {
        \Illuminate\Support\Facades\Mail::raw('SMTP test works perfectly!', function($m) {
            $m->to('jamshid.khaksaar@gmail.com')->subject('SMTP Final Test');
        });
